...
export default {
  ...
  theme: {
    ...
    extend: {
      colors: {
        // ... your existing colors are perfect
      ...
      // MERGED KEYFRAMES AND ANIMATIONS
      keyframes: {
        // Existing keyframes
        'accordion-down': {
          from: { height: '0' },
        ...
        // Added keyframes for the FullPageLoader
        dash: {
      ...
      animation: {
        ...
        // Added animations for the FullPageLoader
        dash: 'dash 1.8s ease-in-out infinite',
